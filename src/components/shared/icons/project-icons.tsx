...
export function TechIcon({ tech }: { tech: string }) {
  return (
    techIconByName[tech] ?? (
      <span className="font-mono text-[9px] uppercase text-foreground/70">
        {toFallbackCode(tech)}
      </span>
    )
  );
...
function toFallbackCode(tech: string): string {
  const parts = tech.replace(/\./g, " ").split(/\s+/).filter(Boolean);
...
const techIconByName: Record<string, ReactNode> = {
  FastAPI: (
    <svg viewBox="0 0 24 24" className="h-5 w-5" aria-hidden>
      ...
      <path
        d="M8 15.7V8.3h5.8v1.7H9.9v1.3h3.4V13H9.9v2.7zM14.8 8.3h1.8v7.4h-1.8z"
        fill="#fff"
      />
    </svg>
  ),
  Django: (
    <svg viewBox="0 0 24 24" className="h-5 w-5" aria-hidden>
      ...
      <path
        d="M8 8.2h1.8v7.6H8zM10.8 8.2h1.8v7.6h-1.8zM13.8 8.2h1.8v5.3c0 2-.9 2.9-2.9 2.9h-.6v-1.5h.5c.8 0 1.2-.3 1.2-1.3z"
        fill="#fff"
      />
    </svg>
  ),
  PostgreSQL: (
    <svg viewBox="0 0 24 24" className="h-5 w-5" aria-hidden>
      <path
        d="M12 2.8c-3.6 0-6.5 2.1-6.5 5.4v6.3c0 2.4 1.7 4.1 4.4 4.1l.1 2.6 2-1.7 2 1.7.1-2.6c2.7 0 4.4-1.7 4.4-4.1V8.2c0-3.3-2.9-5.4-6.5-5.4z"
        fill="#336791"
      />
      <path
        d="M9.2 10.2c0-.7.6-1.2 1.4-1.2h2.8c.8 0 1.4.5 1.4 1.2v1.9c0 .7-.6 1.2-1.4 1.2h-2.8c-.8 0-1.4-.5-1.4-1.2z"
        fill="#fff"
      />
  ...
  TypeScript: (
    <svg viewBox="0 0 24 24" className="h-5 w-5" aria-hidden>
      ...
      <path
        d="M8.2 9.2h7.6v1.9h-2.8V17h-2v-5.9H8.2zm8.1 2.6c.2-1.1 1.1-1.8 2.5-1.8 1.2 0 2.2.5 2.7 1.5l-1.6.9c-.3-.5-.6-.7-1-.7-.4 0-.7.2-.7.5 0 .4.3.6 1.2.9 1.4.5 2.2 1.1 2.2 2.4 0 1.5-1.2 2.5-2.9 2.5-1.7 0-2.8-.8-3.3-2.1l1.6-.8c.3.6.7 1.1 1.6 1.1.6 0 .9-.2.9-.6 0-.4-.3-.6-1.3-.9-1.4-.5-2.2-1.1-2.2-2.4"
        fill="#fff"
      />
    </svg>
  ),
  ...
  "Next.js": (
    <svg viewBox="0 0 24 24" className="h-5 w-5" aria-hidden>
      ...
      <path
        d="M9 8.2v7.6h1.7v-4.2l3.3 4.2H16V8.2h-1.7v4.1l-3.2-4.1z"
        fill="#fff"
      />
    </svg>
  ),
  ...
  Docker: (
    <svg viewBox="0 0 24 24" className="h-5 w-5" aria-hidden>
      ...
      <path
        d="M3 13h13.5c.3 2.6-1.6 4.7-4.6 4.7H7.4C5 17.7 3.2 16.2 3 13z"
        fill="#2496ED"
      />
      <path
        d="M17.2 11.6c.5-.2 1.2-.2 1.8 0 .2-.8-.1-1.5-.7-2 .9-.1 1.8.3 2.3 1-.5.2-.9.8-.9 1.4 0 .8-.6 1.5-1.5 1.6-.4.1-.8.1-1.2 0 .1-.7 0-1.3-.3-2z"
        fill="#2496ED"
      />
    </svg>
  ),
  OpenTelemetry: (
    <svg viewBox="0 0 24 24" className="h-5 w-5" aria-hidden>
      ...
      <path
        d="M7 12h3l1.5-3.2 2.3 6.4 1.2-3.2H17"
        fill="none"
        stroke="#fff"
        strokeWidth="1.7"
        strokeLinecap="round"
