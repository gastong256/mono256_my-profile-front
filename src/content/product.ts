...
export const productContent: ProductContent = {
  ...
  promise: "Connect GitHub. Connect Vercel. Get your repository and deployed website.",
  steps: [
    {
  ...
  installDescription: "Preview the upcoming connection flow for GitHub and Vercel.",
  resultTitle: "Preview summary",
  resultDescription: "This preview shows the expected deliverables and next-step documentation. Public release is coming soon.",
  deliverables: {
