...
export function SiteFooter() {
  return (
    <footer className="shrink-0 border-t border-white/10 bg-background/35">
                ...
                return (
                  <li key={item.label}>
                    <Link
                      ...
                      className="inline-flex h-5 w-5 items-center justify-center text-foreground/70 transition-all duration-150 hover:-translate-y-px hover:text-foreground"
                    >
